        ...
        <div className="card p-8 sm:p-12 space-y-8 text-gray-700 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ul className="space-y-2 list-disc list-inside text-gray-600">
              ...
              <li><span className="font-medium text-gray-800">Gmail OAuth token</span> — a limited-access, send-only token used solely to send the emails you approve, from your own Gmail</li>
            </ul>
          </section>

          <section>
            <h2 className="text-base font-bold text-gray-900 mb-3">3. Gmail Access — What We Do and Do Not Do</h2>
            <p className="mb-3">To deliver your emails from your own Gmail, you authorize IMG Outreach via Google OAuth. We request only the <strong>gmail.send</strong> scope, which allows us to send emails on your behalf — it does not allow us to read, view, or access your inbox or any existing messages.</p>
            ...
            <ul className="space-y-1.5 list-disc list-inside text-gray-600 mb-3">
              ...
              <li>Attach your CV to each email you send</li>
            </ul>
            ...
            <p className="mt-3"><strong>AI and your Google data.</strong> Your outreach drafts are generated by AI from publicly available physician information and the details you enter into our form (such as your CV and letter of interest). We do <strong>not</strong> transfer any Google user data to any third-party AI or machine-learning provider, and no Google user data is ever used to train, retrain, develop, or improve any AI or machine-learning model.</p>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-1.5 list-disc list-inside text-gray-600">
              ...
              <li><span className="font-medium text-gray-800">Google OAuth</span> — sending emails from your Gmail (send-only)</li>
              <li><span className="font-medium text-gray-800">Vercel</span> — website hosting</li>
              <li><span className="font-medium text-gray-800">Anthropic, MiniMax, DeepSeek</span> — AI models that draft and edit your emails from public physician data and the details you provide; they never receive your Google data</li>
              <li><span className="font-medium text-gray-800">Exa, Firecrawl</span> — searching and retrieving publicly available physician information</li>
            </ul>
            <p className="mt-3">Each of these services has its own privacy policy. We share only the minimum data necessary to provide the service, and we never share your Google user data with any of them.</p>
          </section>
